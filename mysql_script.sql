...
temail varchar(20) unique not null,
tdob date,
tmobile_no double);
...
-- Trainer
insert into Trainer values(default,"Vaishali Chikhalkar","MCS","Core Java","vaishali1@gmail.com","1990-04-05",9841253241);
insert into Trainer values(default,"Kishori Khadilkar","MCS","DBT","Kishorik2@gmail.com","1974-08-03",9714523668);
insert into Trainer values(default,"Vishal Jagtap","BE(Computer)","DSA","vishal42@gmail.com","1990-12-07",9654785234);
insert into Trainer values(default,"Ravi Tambade","BE(Computer)",".NET Tech","ravitd4@gmail.com","1973-04-01","9514236789");
insert into Trainer values(default,"Madhura Anturkar","BE(Computer)","Advance Java","madhura54@gmail.com","1978-09-02",9425635897);
