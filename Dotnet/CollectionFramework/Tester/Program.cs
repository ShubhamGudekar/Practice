...
// }
Part p1 = new Part() { PartName = "crank arm", PartId = 1234 };
Part p2=new Part() { PartName = "chain ring", PartId = 1234 };
Part p3=new Part() { PartName = "regular seat", PartId = 1434 };
Part p4=new Part() { PartName = "banana seat", PartId = 1444 };

Console.WriteLine(p1.Equals(p2));
Console.WriteLine(p1.Equals(p3));
Console.WriteLine(p3.Equals(p4));
Console.WriteLine(p1.Equals(1234));
