...
public class ProductManager
    {
        public static List<Product> GetSoldOutProducts()
        {
            ...
            return products.Where(product=>product.Balance==0).ToList();
        }
        ...
        public static List<Product> GetProuductsInStockLessthan(int amount)
        {
            ...
            return products.Where(product=>product.Balance>0 && product.UnitPrice>amount).ToList();
        }
        ...
        public static List<string> GetProjectTitles()
        {
            ...
            return products.Select(product=>product.Title).ToList();
        }
        ...
        public static dynamic GetProductDetails()
        {
            ...
            // return productInfos;
            return products.Select(product=>new {product.Title,product.Category,product.UnitPrice});
        }
        ...
        public static void Takethree()
        {
            ...
            //     Console.WriteLine(n);
            // }
            numbers.Take(3).ToList().ForEach(num=>Console.WriteLine(num));
        }
        ...
        public static void Skip()
        {
            ...
            //     Console.WriteLine(n);
            // }
            numbers.Skip(4).ToList().ForEach(num=>Console.WriteLine(num));
        }
        ...
        public static List<Product> GetProductsOrderby()
        {
            ...
            return products.OrderBy(product=>product.Title).ToList();
        }   
        ...
        public static List<Product> GetProductsByDescending()
        {
            ...
            //     select prod;
            // return sortedProducts as List<Product>;
            return products.OrderByDescending(product=>product.Balance).ToList();
        }
        ...
        public static List<Product> GetProductsGroupByCategory()
        {
           ...
           // return products.GroupBy(product=>product.Category,prod=>prod,()).ToList();
        ...
        public static List<string> GetProductsDistinct()
        {
            ...
            return products.Select(product=>product.Category).Distinct().ToList();
        }
